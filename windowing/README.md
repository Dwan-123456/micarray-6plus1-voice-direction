...
> 项目1.2.1的Windowing已按[`ARCHITECTURE_V1.1_TARGET.md`](../ARCHITECTURE_V1.1_TARGET.md#6-windowing-改动)实现。窗口大小与20 ms节拍保持不变，320 ms是可用历史上限；滚动STFT、协方差、MUSIC和轨迹coasting由L2实现。
