...
- Report the verification performed, commit hash and message, pushed branch, affected release tag if any, Git LFS changes, and whether the working tree is clean.
