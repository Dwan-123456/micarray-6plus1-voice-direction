...
> 项目1.3.1的L1输入已按[`ARCHITECTURE_V1.1_TARGET.md`](../ARCHITECTURE_V1.1_TARGET.md#5-layer-1-改动)落地：提供连续、校准后的7麦输入、verified/unverified状态及版本/hash边界；L1不创建ID，MUSIC与公共方向ID由L2负责。
